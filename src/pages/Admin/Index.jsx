    ...
    <div>
      ...
      <nav
                ...
                <ul class="relative m-0 list-none px-[0.2rem]" data-te-sidenav-menu-ref>
                    <li onClick={() => setIsActive("register")} class="relative">
                        <a
                    ...
                    <li class="relative">
                        ...
                        <ul
                            ...
                            <li onClick={() => setIsActive("profile")} class="relative">
                                <a
                            ...
                            <li onClick={() => setIsActive("users")} class="relative">
